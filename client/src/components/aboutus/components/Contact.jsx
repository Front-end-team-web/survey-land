    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="my-16 grid grid-cols-1 md:grid-cols-2 gap-6 overflow-x-hidden">
          ...
          <motion.div
            className={`flex flex-col justify-between px-8 py-6 rounded-xl border ${
              isDarkMode
            ...
            <form>
              <div className="flex flex-col md:flex-row my-4 gap-6">
                <div className="md:w-1/2 flex flex-col">
                  ...
                  <input
                    type="text"
                    id="name"
                    className={`border-2 focus:outline-none rounded-xl px-3 py-2 w-full ${
                      isDarkMode
              ...
              <div className="flex flex-col my-4">
                ...
                <input
                  type="text"
                  id="subject"
                  className={`border-2 focus:outline-none rounded-xl px-3 py-2 ${
                    isDarkMode
                      ? "bg-gray-700 text-white border-gray-600"
                      : "bg-white text-black border-gray-300"
                  }`}
              ...
              <button className="py-2 px-8 w-full md:w-auto bg-[#7616EC] text-white rounded-md hover:bg-[#6211CC] transition-colors">
