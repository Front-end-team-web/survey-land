        ...
        >
          ...
          >
            <span className="text-[#7616EC]">
              {t("pages.HeroSection.title.part1")}
            </span>{" "}
            {t("pages.HeroSection.title.part2")}{" "}
            <span className="text-[#7616EC] px-2">
              {t("pages.HeroSection.title.part3")}
            </span>
            , {t("pages.HeroSection.title.part4")}
          </motion.h1>

          <motion.p
            className={`mt-4 text-[16px]/relaxed max-w-full lg:max-w-[70%] ${
          ...
          >
            {/* Buttons */}
            <button className="bg-gradient-to-r from-[#490F8F] to-[#7616EC] flex items-center flex-row px-16 py-2 text-white text-body-base rounded-md hover:shadow-lg transition-shadow duration-300">
              <span>{t("pages.HeroSection.buttonOne")}</span>
            </button>

            <div className="flex items-center">
              <button
                className={`border border-[#7616EC] flex items-center hover:bg-gradient-to-r from-[#490F8F] to-[#7616EC] hover:border-0 hover:text-white transition duration-500 ease-in-out flex-row px-16 py-2 text-body-base rounded-md ${
                  isDarkMode ? "text-white" : "text-gray-900"
                }`}
              >
                <span>{t("pages.HeroSection.buttonTwo")}</span>
                <svg
