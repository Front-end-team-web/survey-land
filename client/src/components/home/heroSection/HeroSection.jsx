...
//   console.log("Test simple:", t("navbar.home"));
//   console.log("Test HeroSection direct:", t("HeroSection.title.part1"));
//   console.log(
//     "Test HeroSection with pages:",
//     t("pages.HeroSection.title.part1")
//   );
//   console.log("Test footer direct:", t("footer.desc"));
//   console.log("Test footer with pages:", t("pages.footer.desc"));
//   return (
//     <>
//       <div style={{ background: "yellow", padding: "20px", margin: "10px" }}>
//         <h3>🔍 Debug Info:</h3>
//         <p>Current Language: {currentLanguage}</p>
//         <p>Translation function type: {typeof t}</p>
//         <p>Test navbar.home: {t("navbar.home")}</p>
//         <p>Test HeroSection.title.part1: {t("HeroSection.title.part1")}</p>
//         <p>
//           Test pages.HeroSection.title.part1:{" "}
//           {t("pages.HeroSection.title.part1")}
//         </p>
//       </div>
