    ...
    return (
        <section className="pt-48">
            <div className="container mx-auto px-4">
                ...
                >
                    <h2 className={`text-5xl font-bold font-bold mb-6 leading-snug ${isDarkMode ? " text-white" : "text-black"}`}>
                ...
                >
                    {features.map((feature, index) => (
                        ...
                        >
                            ...
                            <motion.h3
                                className={`text-xl font-bold mb-3 transition-colors duration-300 ${isDarkMode ? "text-white group-hover:text-[#7616EC]" : "text-black group-hover:text-[#490F8F]"}`}
                            >
                                {feature.title}
                            </motion.h3>

                            <motion.p
                                className={`leading-relaxed ${isDarkMode ? "text-white/60" : "text-[#4B5563]"}`}
                            >
                                {feature.description}
                            </motion.p>
                        </motion.div>
