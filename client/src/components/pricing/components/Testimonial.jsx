...
const TestimonialComponent = () => {
  ...
  return (
    <div
      className={`px-4 mx-auto max-w-7xl w-full transition-colors duration-300 ${
    ...
    >
      <div className="text-center py-12 md:py-20 flex flex-col gap-4">
        ...
        >
          {t(
            "pages.pricing.Testimonial.See what our customers have to say about their experience"
          )}
        </p>
      </div>
          ...
          >
            {TestimonialData.map((item, index) => (
              <div key={index} className="flex-shrink-0 w-full px-4">
                <div
                  className={`px-4 py-10 md:p-10 rounded-xl h-fit ${
