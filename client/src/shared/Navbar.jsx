    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-20">
          ...
          {/* Navigation links - Desktop (xl: = 1280px+) */}
          ...
          <div className="flex items-center gap-3">
            {/* Mobile menu button - Visible below 1280px */}
            <button
              onClick={toggleMobileMenu}
              className="xl:hidden p-2 rounded-lg transition-colors duration-200 hover:bg-gray-100 dark:hover:bg-gray-800"
            ...
            {/* Desktop controls - Only visible at 1280px+ */}
        ...
        {/* Mobile menu - Full width dropdown (below 1280px) */}
        {isMobileMenuOpen && (
          <motion.div
